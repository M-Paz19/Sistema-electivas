...
public interface ElectivaService {
     ...
     * @param electiva El objeto Electiva a persistir.
     * @return La electiva guardada con su ID asignado.
     */
    Electiva crearElectiva(Electiva electiva);

    /**
     * HU1.3.2: Actualiza la información de una electiva existente.
     * @param id El ID de la electiva a actualizar.
     * @param electivaDetails El objeto Electiva con la nueva información.
     * @return La electiva actualizada.
     */
    Electiva actualizarElectiva(Long id, Electiva electivaDetails);
