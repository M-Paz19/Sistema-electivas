...
public class ExcelParserServiceImpl implements ExcelParserService {
    ...
    /**
     * Infere el tipo de una materia (OBLIGATORIA, ELECTIVA o TRABAJO_GRADO)
     * a partir de su nombre. Este método se usa cuando el archivo de entrada
     * (por ejemplo, una hoja Excel) no incluye explícitamente el tipo.
     *
     * <p>La lógica está basada en la detección de palabras clave dentro del nombre:
     * <ul>
     *   <li>Si contiene "electiva" o "elective" (pero no "fish") → ELECTIVA.</li>
     *   <li>Si contiene "trabajo de grado", "thesis" o "degree project" → TRABAJO_GRADO.</li>
     *   <li>En cualquier otro caso → OBLIGATORIA (valor por defecto).</li>
     * </ul>
     *
     * @param nombreMateria Nombre de la materia (puede ser nulo).
     * @return Tipo inferido en formato de texto.
     */
    private TipoMateria inferirTipo(String nombreMateria) {
        if (nombreMateria == null) {
            return TipoMateria.OBLIGATORIA;
        }
    ...
    /**
     * Obtiene el valor entero de una celda de Excel.
     *
     * <p>Este método maneja celdas de tipo numérico y texto,
     * intentando convertirlas a {@link Integer}. Si la celda no
     * contiene un valor numérico válido, devuelve {@code null}.
     *
     * @param row      Fila actual de la hoja Excel.
     * @param colIndex Índice de la columna a leer (puede ser nulo).
     * @return Valor entero de la celda, o {@code null} si no puede parsearse.
     */
