...
public interface ElectivaService {
     ...
     */
    ElectivaResponseDTO actualizarElectiva(Long id, ActualizarElectivaDTO dto);
     ...
     */
    List<ElectivaResponseDTO> findElectivas(boolean mostrarInactivas, String query);

    /**
     * Buscar electivas por el id.
     * @param id el ID de la electiva a buscar
     * @return la electiva encontrada con el id corresponsiente.
     */
    ElectivaResponseDTO buscarPorId(Long id);
}